...
MEDIA_ROOT = '/home/bitnami/media'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'http://192.168.0.3/bookstore/media/'
...
SECRET_KEY = ')zwee*jo+qn=g-b+mp!+83)8-knf8oc96f3!sg@t4q8clpzu_('
